...
from settings.models import headerFooterSetting
...
def register(request):
    ...
    return render(request, 'authenticate/auth/register.html', context)
...
def LogOut(request):
    ...
    setting = headerFooterSetting.objects.first()
    if setting:
        setting.header_button_text = 'Login'  # Changez le texte en 'Logout'
        setting.header_button_url = '/login'
        setting.save()
    return redirect('logIn')
